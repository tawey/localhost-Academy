...
<body class="d-flex flex-column h-100">
    ...
    <main class="flex-shrink-0">
        <div class="container">
            <h1 class="mt-5">Page Contact</h1>
            <p class="lead"> Entrer en contact avec Georges Tawey </p>
            <form class="d-flex" role="search">
                
          <input class="form-control me-2" type="textarea" placeholder="Placer votre commentaires" width="200">
          <button class="btn btn-outline-success" type="soummettre">soumettre</button>
        </form>
